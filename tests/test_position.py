...
class TestPositionManager(unittest.TestCase):
    ...
    def test_on_order_fill_closes_position(self):
        ...
        self.assertEqual(pos.close_price, 60000000.0)
